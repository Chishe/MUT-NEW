...
import type { MachineControl } from "@/types/machine";
  ...
  return (
    <Card className="h-full bg-gradient-to-br from-white/10 to-white/5 border border-white/20 backdrop-blur-xl rounded-3xl shadow-2xl">
      <CardContent className="h-full flex flex-col items-center justify-center gap-16 py-12">
        ...
        {/* 🟡 SELECTOR */}
        <div className="flex flex-col items-center gap-6">
          <div className="relative w-30 h-30 rounded-full bg-gradient-to-br from-yellow-300 to-yellow-500 border-[6px] border-yellow-700 flex items-center justify-center shadow-inner shadow-black/40 transition-all duration-500">
            <div
              className={`absolute w-4 h-24 bg-black border-yellow-700 rounded-full shadow-lg transition-all duration-500 ${
